<div class="thumbnail">
    <img src="img/badges/via-lux-adventurer.png" alt="Via Lux Adventurer badge" class="img-responsive img-thumbnail" />
    <h1 class="text-uppercase text-center">Via Lux Adventurer</h1>
    <p>
